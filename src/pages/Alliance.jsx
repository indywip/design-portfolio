...
const Alliance = () => {
  return (
      <Wrapper>
        ...
        <SubHead style={{ marginTop: '-28px' }}>OVERVIEW</SubHead>
        <Overview>
            <TextGroup>
        ...
        <Body>
            ...
            <Text style={{ marginTop: '-20px' }}>
                ...
                <Center><Image5 src={`https://imgur.com/BZxBEe3.png`} /></Center><br/><br/>
                ...
                <Center><Image6 src={`https://imgur.com/Fi66ZAx.png`} /></Center><br/><br/>
